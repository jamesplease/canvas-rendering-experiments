...
var imgToDraw, imageCanvas, iCtx, imageData,
  imagePixData, imgWidth, imgHeight;
...
function draw() {
  ...
  for (var nObject = 0; nObject < numberOfObjects; nObject++) {
    ...
    var velY = Math.cos(entity.angle * Math.PI / 180) * entity.speed;
    var velX = Math.sin(entity.angle * Math.PI / 180) * entity.speed;
